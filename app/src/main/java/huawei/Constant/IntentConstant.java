...
public class IntentConstant
{
    ...
    public static final String CALL_OUT_ACTIVITY_ACTION = "android.intent.action.call_out_activity4szga";
    public static final String CALL_IN_ACTIVITY_ACTION = "android.intent.action.call_in_activity4szga";
    public static final String CREATE_CONF_ACTIVITY_ACTION = "android.intent.action.create_conf_activity";
    public static final String VIDEO_ACTIVITY_ACTION = "android.intent.action.video_activity4szga";
    ...
    public static final String CONF_MANAGER_ACTIVITY_ACTION = "android.intent.action.conf_manager_activity4szga";
