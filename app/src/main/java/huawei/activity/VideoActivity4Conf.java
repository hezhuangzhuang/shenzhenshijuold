 ...
 * 视频界面
 */
public class VideoActivity4Conf extends BaseLibActivity implements LocBroadcastReceiver, View.OnClickListener, CancelAdapt {
    public static VideoActivity4Conf mInstance;
...
//        executorShutDown();
    ...
    public void onClick(View v) {
        if (R.id.tv_hang_up == v.getId()) {
            ...
            //结束会议
            if (isCreater) {
                Utils.makeDialog(VideoActivity4Conf.this, "提示", "您需要离开会议还是结束会议？", "离开会议", "结束会议", new DialogInterface.OnClickListener() {
                    //离开会议
                    @Override
...
//            }
            ...
            PopMeetingControl popMeetingControl = new PopMeetingControl(VideoActivity4Conf.this, String.valueOf(currConfID));
